...
<body>
      ...
      <div class="card">
        ...
        <div class="card-content">
          ...
          <div class="intro-buttons">
            <a href="./appeal/xz.php" class="btn btn-primary btn-lg">我要申诉</a>
            <a href="./query.php" class="btn btn-primary btn-lg">我要查询</a>
            <a href="./report/xz.php" class="btn btn-primary btn-lg">我要举报</a>
          </div>
        </div>
      </div>
  ...
  <script>
    fetch("https://tenapi.cn/v2/yiyan")
      ...
      .then(data => {
        document.getElementById("yiyan").textContent = data.data.content;
      })
