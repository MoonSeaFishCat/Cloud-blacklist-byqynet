...
<body>
  ...
  <div class="sidebar">
    <ul class="nav flex-column">
      <li class="nav-item">
        <a class="nav-link" href="data-center.php">数据中心</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="system-config.php">系统配置</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="manage_list.php">管理员列表</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="cloud-blacklist.php">云黑信息</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="cloud-blacklist-sh.php">云黑审核</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="appeal-list.php">申诉信息</a>
      </li>
      <li class="nav-item">
